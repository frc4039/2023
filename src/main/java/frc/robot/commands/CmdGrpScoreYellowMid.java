...
public class CmdGrpScoreYellowMid extends SequentialCommandGroup {
    /** Creates a new ScoreYellowMid. */
    public CmdGrpScoreYellowMid(Pivot s_Pivot, Gripper s_Gripper, Telescopic s_Telescopic,
        ...
        addCommands(
                ...
                // extend to far
                new TelescopicScoringExtendMid(s_Telescopic, s_Pivot).withTimeout(0.35), // shouldnt need a timeout
                                                                                         // here....
                // score
