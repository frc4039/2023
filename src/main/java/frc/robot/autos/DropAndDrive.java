...
import frc.robot.commands.SeqCmdCubeScoringPosition;
import frc.robot.commands.SeqCmdTravelPosition;

public class DropAndDrive extends SequentialCommandGroup {

	public DropAndDrive(RobotContainer container) {
		addCommands(
	...
	private Trajectory path = TrajectoryGenerator.generateTrajectory(
